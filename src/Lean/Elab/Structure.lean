  ...
  withFields view.fields fieldInfos fun fieldInfos => do
    ...
    withUsed view.scopeVars view.params fieldInfos fun scopeVars => do
      ...
      | Except.ok levelParams =>
        ...
        projInstances.forM fun declName => addInstance declName AttributeKind.global 500
        copiedParents.forM fun parent => mkCoercionToCopiedParent levelParams params view parent 500
        let lctx ← getLCtx
